...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 1 \"include/e6nlaq/io.hpp\"\n\n\n\n#include <concepts>\n#include\
    \ <iostream>\n\n#line 1 \"include/e6nlaq/iostream.hpp\"\n\n\n\n#include <cassert>\n\
    #line 6 \"include/e6nlaq/iostream.hpp\"\n#include <string>\n#include <vector>\n\
  ...
  code: "#ifndef E6NLAQ_IO_HPP\n#define E6NLAQ_IO_HPP 1\n\n#include <concepts>\n#include\
    ...
    \u3058\u3066\u7570\u306A\u308B\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u51FA\u529B\
    \u3059\u308B\n * @tparam T bool\u306B\u5909\u63DB\u53EF\u80FD\u306A\u578B\n *\
    \ @tparam tr \u771F\u306E\u5834\u5408\u306B\u51FA\u529B\u3059\u308B\u5024\u306E\
    \u578B\n * @tparam fal \u507D\u306E\u5834\u5408\u306B\u51FA\u529B\u3059\u308B\u5024\
    \u306E\u578B\n * @param b \u6761\u4EF6\n * @param tru \u771F\u306E\u5834\u5408\
    \u306B\u51FA\u529B\u3059\u308B\u5024\n * @param fals \u507D\u306E\u5834\u5408\u306B\
    \u51FA\u529B\u3059\u308B\u5024\n */\ntemplate <typename T, typename tr, typename\
    \ fal>\n    requires std::convertible_to<T, bool>\ninline void outif(T b, tr tru,\
    \ fal fals) {\n    co(b ? tru : fals);\n}\n\n/**\n * @brief \u6A19\u6E96\u5165\
    \u51FA\u529B\u306E\u9AD8\u901F\u5316\u3092\u884C\u3046\n * @note C++\u306E\u6A19\
    \u6E96\u5165\u51FA\u529B\u3092\u9AD8\u901F\u5316\u3059\u308B\u305F\u3081\u306E\
