...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"include/e6nlaq/string.hpp\"\n\n// This file is a fork of\
    \ AtCoder Library.\n\n#define E6NLAQ_STRING_HPP\n\n#include <algorithm>\n#include\
    \ <cassert>\n#include <numeric>\n#include <string>\n#include <vector>\n\nnamespace\
    \ e6nlaq {\n\nnamespace internal {\n\ninline std::vector<int> sa_naive(const std::vector<int>&\
    \ s) {\n    int n = int(s.size());\n    std::vector<int> sa(n);\n    std::iota(sa.begin(),\
  ...
  verifiedWith: []
documentation_of: include/e6nlaq/string.hpp
layout: document
redirect_from:
- /library/include/e6nlaq/string.hpp
- /library/include/e6nlaq/string.hpp.html
