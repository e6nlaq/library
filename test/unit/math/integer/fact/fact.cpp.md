...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/unit/math/integer/fact/fact.cpp\"\n#define LIBTEST\n\
  ...
  verifiedWith: []
documentation_of: test/unit/math/integer/fact/fact.cpp
layout: document
redirect_from:
- /library/test/unit/math/integer/fact/fact.cpp
- /library/test/unit/math/integer/fact/fact.cpp.html
